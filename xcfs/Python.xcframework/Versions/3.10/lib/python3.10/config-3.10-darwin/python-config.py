#!/Users/jayl/git/XCFrameworkBuilder/mac/build/Python/macos-arm64_x86_64/mac_universal/install_dir/Frameworks/Python.framework/Versions/3.10/bin/python3.10
# -*- python -*-
