...
class TestNotebookWebSocket:
    ...
    async def test_cell_stream_tqdm_nested(
        ...
        """
        Handle the ANSI \x1b[A code, which happens when tqdm loops are nested
        """
        uuid = await upload_notebook(
            client, superuser_token_headers, "carriage_return_test.ipynb"
        )
        ...
        async with client.websocket_connect(
            ...
            def check_cell_update(data, lines):
                ...
                for idx, line in enumerate(lines):
                    ...
                    if isinstance(line, str):
                        ...
                        assert text.endswith("it/s]\n")
                        assert len(text) == 101

            check_cell_update(cell_update_msgs.pop(0), [(0, 0, 7)])
            check_cell_update(cell_update_msgs.pop(0), [(0, 0, 7), "\n"])
            check_cell_update(cell_update_msgs.pop(0), [(0, 0, 7), (0, 0, 4)])
            check_cell_update(cell_update_msgs.pop(0), [(0, 0, 7), (25, 1, 4)])
            check_cell_update(cell_update_msgs.pop(0), [(0, 0, 7), (50, 2, 4)])
            check_cell_update(cell_update_msgs.pop(0), [(0, 0, 7), (75, 3, 4)])
            check_cell_update(
                cell_update_msgs.pop(0), [(0, 0, 7), (100, 4, 4)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (100, 4, 4)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (14, 1, 7)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (29, 2, 7)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7), "\n"]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7), (0, 0, 4)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7), (25, 1, 4)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7), (50, 2, 4)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7), (75, 3, 4)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (43, 3, 7), (100, 4, 4)]
            )
            check_cell_update(
            ...
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (100, 4, 4), (57, 4, 7)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (100, 4, 4), (71, 5, 7)]
            )
            check_cell_update(
                cell_update_msgs.pop(0), [(100, 4, 4), (100, 4, 4), (86, 6, 7)]
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (86, 6, 7), "\n"],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (86, 6, 7), (0, 0, 4)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (86, 6, 7), (25, 1, 4)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (86, 6, 7), (50, 2, 4)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (86, 6, 7), (75, 3, 4)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (86, 6, 7), (100, 4, 4)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (100, 4, 4), (100, 4, 4)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (100, 4, 4), (100, 7, 7)],
            )
            check_cell_update(
                cell_update_msgs.pop(0),
                [(100, 4, 4), (100, 4, 4), (100, 4, 4), (100, 7, 7)],
    ...
    async def test_cell_stream_ansi_code(
        ...
        """
        Test the ANSI codes, with some prints
        """
        uuid = await upload_notebook(
            client, superuser_token_headers, "carriage_return_test.ipynb"
        )
    ...
    async def test_notebook_sequential_execute(
        ...
        async with client.websocket_connect(
            ...
            for cell_uuid in (cell_uuid1, cell_uuid2, cell_uuid3):
                ...
                ututils.assertCountEqual(data["cell_update_patch"]["patch"], patches)
...
class TestKernelVarsManager:
    ...
    async def test_get_single_var_detail_sorting(
        ...
        async with client.websocket_connect(
            ...
            assert single_var["summary"] == "Size: 6x3 Memory: 572.0 Bytes"
            assert single_var["abbreviated"] is False
            assert single_var["has_next_page"] is False
